-- 0085_scope_rollup_drilldown.down.sql
-- Restores 0082's rollup: the COUNTRY level stays distributor-scoped, but the
-- region/district/branch/agent drill-downs go back to platform-wide. ⚠️ That
-- re-opens the cross-tenant read — a distributor can pass ANY entity id and get
-- real metrics back, because the function is SECURITY DEFINER and bypasses the
-- 0081/0084 policies entirely.
