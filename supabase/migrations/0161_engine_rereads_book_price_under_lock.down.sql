-- DOWN for 0161_engine_rereads_book_price_under_lock.sql
-- ============================================================================
-- ⚠️ Restores the cached book price, so a publish committing while a member RPC
-- is blocked on that member's balance row can leave exactly that member marked
-- at the previous price, raising nav_mismatch for them with nothing to repair
