-- =============================================================================
-- DOWN for 0106_nav_publish_where_clause.sql
-- =============================================================================
-- Restores the pre-0106 body, which omits the WHERE clauses. ⚠️ That version
-- CANNOT be called through PostgREST: Supabase runs the API roles with
-- sql_safe_updates = on, so every publish fails with "UPDATE requires a WHERE
-- clause". Only roll this back together with 0104.
-- =============================================================================
