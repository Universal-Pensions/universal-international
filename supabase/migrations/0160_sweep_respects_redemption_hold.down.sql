-- DOWN for 0160_sweep_respects_redemption_hold.sql
-- ============================================================================
-- ⚠️ Lets the save-to-cover sweep spend savings that a pending withdrawal has
-- already promised to the member. Balances stay consistent; the member's own
-- withdrawal is simply rejected at its dealing date instead, with nothing
-- linking that to the premium that took the money.
-- ============================================================================
