  ...
  return (
    <div className={styles.screen}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.featRow}><span className={styles.fpi}><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="m5 13 4 4L19 7" /></svg></span><div><b>Staff and company contributions</b><span>Set what comes out of staff pay and what the company adds — either can be nothing.</span></div></div>
