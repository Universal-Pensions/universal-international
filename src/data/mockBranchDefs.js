// Branch definitions — the static array of ~314 branches across the 135
// Ugandan districts. Pure data; the populated `BRANCHES` map (with manager,
// metrics, etc.) is built from this in `mockData.js` and lives on the live
// mock store.
